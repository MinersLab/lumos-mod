...
class LumiumConversionRecipeInput(val itemStack: ItemStack) : RecipeInput {
...
class LumiumConversionRecipe(val inputItem: Ingredient, val result: ItemStack) : Recipe<LumiumConversionRecipeInput> {

    override fun matches(input: LumiumConversionRecipeInput, level: Level) =
        inputItem.test(input.itemStack)

    override fun assemble(input: LumiumConversionRecipeInput, registries: HolderLookup.Provider): ItemStack =
        result.copy()
    ...
    override fun getSerializer(): LumiumConversionRecipeSerializer =
        ModRecipeSerializers.LUMIUM_CONVERSION_RECIPE_SERIALIZER.get()
    ...
    companion object {
        ...
        val STREAM_CODEC: StreamCodec<RegistryFriendlyByteBuf, LumiumConversionRecipe> =
            StreamCodec.composite(
                Ingredient.CONTENTS_STREAM_CODEC, LumiumConversionRecipe::inputItem,
                ItemStack.STREAM_CODEC, LumiumConversionRecipe::result,
